        ...
        <div className='navContainer'>
            <nav className="fixed mb-60  z-50 w-full bg-tranparent border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-red-800 w-100 " >
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <Link to="/" style={{ textDecoration: "none", fontWeight: "bold" }} className="flex font-bold">
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <NavLink as={Link} to="/" style={{ textDecoration: "none", fontWeight: "bold" }} className="block py-2 pr-4 pl-3 text-gray-700 bg-blue-700 rounded md:bg-transparent  md:p-0 dark:text-white" >Home</NavLink>
                            </li>
                            <li>
