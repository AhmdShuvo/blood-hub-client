...
const Header = () => {
    return (
        <div className='navContainer'>
            <nav className="fixed mb-60  z-50 w-full bg-tranparent border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-red-800 w-100 " >
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="#g" style={{ textDecoration: "none", fontWeight: "bold" }} className="flex font-bold">
                       <img src="https://i.ibb.co/6ZXnS2b/logo-bloodhub-removebg-preview.png" alt="blood Hub logo" width="130px" />
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <NavLink as={Link} to="/" style={{ textDecoration: "none", fontWeight: "bold" }} className="block py-2 pr-4 pl-3 text-gray-700 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</NavLink>
                            </li>
                            <li>
                                <NavLink as={Link} to="/about" style={{ textDecoration: "none", fontWeight: "bold" }} className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</NavLink>
                            </li>
                            <li>
                                <NavLink as={Link} to="/products" style={{ textDecoration: "none", fontWeight: "bold" }} className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</NavLink>
                            </li>
                            <li>
